  ...
  let restaurantHTML = restaurant.map(function (currentRestaurant) {
    let restaurantHTMLString = `
            <div class="card bg-dark text-white hover-card">
                ...
                <div class="top-right">
                  <button id="favorite-icon" onclick="saveToFavoriteRestaurant('${currentRestaurant.id}')" type="submit" class="btn button-topright"><i class="fas fa-heart"></i></button>
                  <button id="saveres-icon" onclick="saveToRestaurantToVisitList('${currentRestaurant.id}')" type="submit" class="btn button-topright"><i class="fas fa-star"></i></button>
                </div>
            </div>
        `
